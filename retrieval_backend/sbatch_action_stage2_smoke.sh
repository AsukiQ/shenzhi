#!/bin/bash
#SBATCH --job-name=shenzhi_action_s2
#SBATCH -p gpu_a800,gpu_h100,gpu_h200
#SBATCH --gpus=1
#SBATCH --cpus-per-task=6
#SBATCH --time=02:00:00
#SBATCH --output=/data/home/scyb713/run/xzf/AAAI/autodl-tmp/shenzhi/logs/action-stage2-smoke-%j.out
set -euo pipefail
...
bash retrieval_backend/run_action_stage2_smoke.sh
