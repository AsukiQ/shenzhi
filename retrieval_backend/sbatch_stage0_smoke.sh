#!/bin/bash
#SBATCH --job-name=shenzhi_s0_smoke
#SBATCH -p gpu_a800,gpu_h100,gpu_h200
#SBATCH --gpus=1
#SBATCH --cpus-per-task=6
#SBATCH --time=01:00:00
#SBATCH --output=/data/home/scyb713/run/xzf/AAAI/autodl-tmp/shenzhi/logs/stage0-smoke-%j.out
...
MODEL_PATH=/data/home/scyb713/run/xzf/AAAI/autodl-tmp/clstrs/clstr/.cache/hf_models/SkillRouter-Embedding-0.6B
...
cd "$SHENZHI_ROOT"
bash retrieval_backend/run_stage0_smoke.sh
