#!/bin/bash
#SBATCH --job-name=shenzhi_action_s2_full
#SBATCH -p gpu_a800
#SBATCH --gpus=1
#SBATCH --cpus-per-task=6
#SBATCH --time=03:00:00
#SBATCH --output=/data/home/scyb713/run/xzf/AAAI/autodl-tmp/shenzhi/logs/action-stage2-full-%j.out
set -euo pipefail
...
bash retrieval_backend/run_action_stage2_full.sh
