...
from clstr.clstr_retrieval_adapters import run_clstr_qdoc_rerank_warmup


def main() -> None:
    parser = argparse.ArgumentParser(description="Run CLSTR q/doc listwise rerank warmup on SKILLRET.")
    ...
    parser.add_argument("--output_dir", default="outputs/skillret_warmup_clstr_qdoc_rerank")
    ...
    parser.add_argument("--reranker_mode", choices=["residual", "legacy_mlp"], default="residual")
    ...
    report = run_clstr_qdoc_rerank_warmup(**vars(args))
