...
def main() -> int:
    parser = argparse.ArgumentParser(description="BGE ToolRex Tool-Embed full encoder finetune.")
    ...
    report = run_bge_sr_embedding_full_train(
        ...
        max_hard_negative_queries=0,
        learning_rate=args.learning_rate,
        temperature=args.temperature,
        seed=args.seed,
        max_length=args.max_length,
        encode_batch_size=args.encode_batch_size,
        mine_score_batch_size=1,
        torch_dtype=args.torch_dtype,
        use_bf16_autocast=args.use_bf16_autocast,
        mining_use_bf16_autocast=False,
        ...
        method_name="bge_tool_embed_full_encoder_finetune",
        checkpoint_prefix="bge-m3-tool-embed",
        training_objective="multi_positive_inbatch_infonce_with_uniform_catalog_negatives",
        doc_template="skillret_official_full_text",
        log_prefix="bge-toolrex-tool-embed",
    )
