...
TRAJECTORIES_PATH=${TRAJECTORIES_PATH:-data/clstr_unified_pretrain_v4_2_progressive_final_function_aug_v2/trajectories.jsonl}
SKILLS_PATH=${SKILLS_PATH:-data/clstr_unified_pretrain_v4_2_progressive_final_function_aug_v2/skill_pool.jsonl}
OUTPUT_DIR=${OUTPUT_DIR:-outputs/clstr_unified_stage4_function_aug_v2_true_adapt_s0_top500_stage0prior50_rankprior_l050_joint_act}
...
HEAD_CHECKPOINT_PATH=${HEAD_CHECKPOINT_PATH:-outputs/clstr_unified_stage2_function_aug_v2_true_adapt_s0_top500_stage0prior50_rankprior_trainl025_calib_full/checkpoints/clstr_full_base-step10000.pt}
MAX_STEPS=${MAX_STEPS:-2000}
BATCH_SIZE=${BATCH_SIZE:-8}
LEARNING_RATE=${LEARNING_RATE:-1.0e-4}
SEED=${SEED:-17}
CANDIDATE_COUNT=${CANDIDATE_COUNT:-50}
STAGE0_TOP_M=${STAGE0_TOP_M:-500}
STAGE0_INVENTORY_MIN_CANDIDATES=${STAGE0_INVENTORY_MIN_CANDIDATES:-50}
...
export STAGE0_TOP_M STAGE0_INVENTORY_MIN_CANDIDATES STAGE0_POSITIVE_MISSING_POLICY
export STAGE0_HANDOFF_QUERY_MODE STAGE0_HANDOFF_SAMPLE_MULTIPLIER
export STAGE0_CANDIDATE_ENCODE_BATCH_SIZE STAGE0_CANDIDATE_PROGRESS_INTERVAL_BATCHES
