...
OUTPUT_DIR=${OUTPUT_DIR:-outputs/clstr_unified_stage2_v4_1b_aggressive_top50_listwise_trajectory_prior}
...
STAGE1_CHECKPOINT_PATH=${STAGE1_CHECKPOINT_PATH:-outputs/clstr_unified_stage1_v4_1b_aggressive_top50_listwise_trajectory_prior_heads_init/checkpoints/clstr_stage1_heads-step3000.pt}
...
gate = {
    ...
    "note": "v4.1b aggressive top50 Stage2 uses the existing Stage1 handoff manifest as its Stage0 handoff gate.",
}
...
export TRANSITION_INVENTORY_MASK_MODE=${TRANSITION_INVENTORY_MASK_MODE:-stage0_topk_trajectory_prior}
export TRANSITION_INVENTORY_MIN_CANDIDATES=${TRANSITION_INVENTORY_MIN_CANDIDATES:-50}
