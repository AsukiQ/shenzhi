...
OUTPUT_DIR=${OUTPUT_DIR:-outputs/clstr_unified_stage2_v4_1b_conservative_top350_listwise_nomask}
...
STAGE1_CHECKPOINT_PATH=${STAGE1_CHECKPOINT_PATH:-outputs/clstr_unified_stage1_v4_1b_conservative_top350_listwise_nomask_heads_init/checkpoints/clstr_stage1_heads-step3000.pt}
V4_1B_HANDOFF_MANIFEST=${V4_1B_HANDOFF_MANIFEST:-outputs/clstr_unified_stage1_v4_1b_conservative_top350_listwise_nomask_heads_init/stage0_candidate_handoff.json}
...
gate = {
    ...
    "note": "v4.1b conservative listwise Stage2 uses the matching Stage1 handoff manifest as its Stage0 handoff gate.",
}
