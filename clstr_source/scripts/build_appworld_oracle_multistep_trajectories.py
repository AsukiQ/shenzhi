...
from clstr.appworld_multistep import build_appworld_oracle_multistep_trajectories


def main() -> None:
    parser = argparse.ArgumentParser(description="Build train-only AppWorld oracle API-trace multi-step trajectories.")
    ...
    parser.add_argument("--output_path", default="data/appworld_multistep/oracle_train_trajectories.jsonl")
    parser.add_argument("--manifest_path", default="data/appworld_multistep/oracle_train_manifest.json")
